          ...
          <v-col cols="10" xs="8" sm="9" md="10">
            <v-row justify="space-between" class="mx-0 px-0">
              <v-col cols="2" xs="12" sm="12" md="2" lg="2" xl="2">
                <div
                >
                 <img src="https://upload.wikimedia.org/wikipedia/vi/thumb/b/bf/Logo_HUET.svg/1200px-Logo_HUET.svg.png" width='100px' />
                </div>
              </v-col>
              <v-col cols="12" sm="12" md="6" lg="6">
                <div
                  class="text-xl-h2 text-sm-h3 font-weight-black text-no-wrap"
              >
